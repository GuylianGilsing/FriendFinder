    ...
    */
    ...
    'config' => [
        ...
        \SlevomatCodingStandard\Sniffs\Functions\FunctionLengthSniff::class => [
            'maxLinesLength' => 25,
            'exclude' => [
                './src/ProfileInformation/UseCases/CreateProfile.php',
                './src/ProfileInformation/_dependency-injection.php',
                './src/setup.php',
            ],
        ],
        ...
        \NunoMaduro\PhpInsights\Domain\Insights\ForbiddenNormalClasses::class => [
            'exclude' => [
                './src/ProfileInformation/Domain/Interest.php',
                './src/ProfileInformation/Domain/Profile.php',
            ],
        ],
    ],
