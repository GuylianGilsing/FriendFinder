...
function configure_application(App $app): void
{
    ...
    $app->get('/healthcheck', \FriendFinder\ProfileInformation\HealthCheck\Handler::class);
}

function configure_rest_api(REST $api): void
{
    $api->registerEndpoint(new \FriendFinder\ProfileInformation\Endpoints\CreateProfileEndpoint());
    $api->registerEndpoint(new \FriendFinder\ProfileInformation\Endpoints\ViewProfileEndpoint());
    $api->registerEndpoint(new \FriendFinder\ProfileInformation\Endpoints\DeleteProfileEndpoint());
}
