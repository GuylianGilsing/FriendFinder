...
final class ArgsValidator implements ValidatorInterface
{
    ...
    public function __construct(
        ...
        $validators = [
            ...
            'requestID' => [required(), isString(), notEmpty()],
            'requestBody' => [
                'answer' => [required(), notEmpty(), in($this->contactInformationRequestAnswerOptions())],
            ],
        ];
        $errorMessages = [];
     ...
     * @return array<string>
     */
    private function contactInformationRequestAnswerOptions(): array
    {
        return [
            ContactInformationRequestAnswerOption::ACCEPTED->value,
            ContactInformationRequestAnswerOption::DENIED->value,
        ];
    }
}
